...
//    }
    ...
    public postsModel(String postid, boolean approval, int likes, long time, ArrayList<Comment> comments, ArrayList<likesModel> likefids, String title, String photoid, String clubName) {
        this.postid = postid;
        this.approval = approval;
        this.likes = likes;
        this.time = time;
